...
(async function () {
    try {
        ...
        await createCourse(course_info, '大学英语', 'https://oc.sjtu.edu.cn/courses/11111', '11111');
        ...
        //await updateCourseData(course_info, '大学英语', ['announcements'], {ann_id: '10001'},  { ann_message: '更新了公告'});

        // 删除 index 为0的 announcement
        //await deleteCourseData(course_info, '大学英语', ['announcements'], {ann_id : '10001'});

        //await deleteCourseData(course_info, '操作系统', ['modules', 'attachments'], {module_id : 'context_module_252143', attachment_id: '1041918'});

        //await deleteManyCourseData(course_info, '大学物理（荣誉）（1）', ['assignments']);
